...
impl Reporter {
    ...
    fn report_github_actions(&self, errors: &[LintError], path: &Path) {
        for line in Self::format_github_actions(errors, path) {
            println!("{}", line);
        }
    }

    fn format_github_actions(errors: &[LintError], path: &Path) -> Vec<String> {
        let path_str = path.display();
...
mod tests {
    ...
    #[test]
    fn test_github_actions_error_format() {
        ...
        let lines = Reporter::format_github_actions(&errors, path);
    ...
    #[test]
    fn test_github_actions_warning_format() {
        let errors = vec![make_error(
    ...
    #[test]
    fn test_github_actions_without_column() {
        let errors = vec![make_error(
            "indent",
            "style",
            "Wrong indentation",
    ...
    #[test]
    fn test_github_actions_without_line_and_column() {
        let errors = vec![make_error(
            "some-rule",
            "best-practices",
            "Something is wrong",
    ...
    #[test]
    fn test_github_actions_sorted_by_line_and_column() {
        let errors = vec![
    ...
    #[test]
    fn test_github_actions_empty_errors() {
